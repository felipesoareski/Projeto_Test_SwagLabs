...
class LoginPage(BasePage):
    ...
    def __init__(self):
        ...
        self.error_message_login = (By.XPATH, '//*[contains(text(), "Epic sadface: ")]')
    ...
    def verificar_texto_mensagem_erro_login(self, texto_esperado):
        ...
        assert texto_esperado == texto_encontrado, f"o texto retornado foi '{texto_encontrado}', mais era esperado o texto '{texto_esperado}' "
